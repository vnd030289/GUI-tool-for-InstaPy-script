namespace InstaPy
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "InstaPy Manager";
			// 
			// label3
			// 
			...
			this.label3.Text = "Win GUI         InstaPy";
			// 
			// label4
			// 
			...
			this.linkLabel1.Location = new System.Drawing.Point(172, 137);
			...
			this.linkLabel2.Location = new System.Drawing.Point(306, 137);
